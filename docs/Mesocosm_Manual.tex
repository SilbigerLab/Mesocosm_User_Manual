...
\item
  ...
  \item
    ...
    \item
      Three carbon filters are in place, the open PVC end wedged into
      the holes of the PVC located in the back of the holding tank
    \item
      If you do not intend to use the secondary sump, close the Sump
      Exchange valve (see image below)
    \item
      Check that all power cords are away from areas with possible water
      exposure \includegraphics{images/Pump_Valve.png}
    \end{enumerate}
  \end{enumerate}
\item
  Once you pick up the truck from behind Chaparral Hall, back it up to
  the large stacked square bins in the same parking lot, near the side
  of the building on the grass.
