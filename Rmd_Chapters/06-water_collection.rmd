...
1. Open the t-valve at the base of the pool hose **half-way (at a 45 degree angle)** and fully open adjacent garden hose (t-valve parallel to the PVC).
    ...
    ![Figure 1. Hose T-valve Alignments](images/SCMI_hose_valves.png)  
...
![Figure 2. SCMI Filter System](images/SCMI_filter_pvc.png)  
...
1. Attach the banjo adapter to the triple filter, then turn on the power supply again.  This will initiate flow through the filters and into the bins.  To avoid pressure build-up in the system, allow the SCMI garden hose to continuously pump water into the drain port.
1. Fillin the bins
